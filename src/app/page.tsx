        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-4">
            <a 
              ...
              className="bg-[#25D366] text-white px-8 py-4 rounded-xl font-bold text-lg hover:opacity-90 transition-opacity"
            >
              🟢 Escribir por WhatsApp
            </a>
            <a 
              href="tel:658312752" 
              className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-brand-dark transition-colors"
            >
      ...
      <section className="py-16 bg-brand-mint text-white text-center px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="https://wa.me/34658312752" className="bg-[#25D366] text-white px-8 py-4 rounded-xl font-bold text-lg hover:opacity-90">
              🟢 Escribir por WhatsApp
            </a>
            <Link href="/contacto" className="bg-white text-brand-dark px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100">
